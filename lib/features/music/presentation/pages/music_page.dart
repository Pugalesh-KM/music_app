...
import 'package:music_app/core/dependency_injection/injector.dart';
...
class _MusicPageState extends State<MusicPage> {
  ...
  void _initializeCubit() async {
    final musicUseCases = injector<MusicUseCases>();
    _musicCubit = MusicCubit(musicUseCases);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => _musicCubit..checkPermissionAndScan(),
              ...
              body: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        _musicCubit.requestPermissions();
                        //context.read<MusicCubit>().requestPermissions();
                      },
                      child: Text('Access to Storage'),
                    ),
                  ],
                ),
              ),
          ...
          if (state is MusicLoaded) {
            return Scaffold(
              appBar: AppBar(
                ...
                actions: [
                  IconButton(onPressed: ()=> _musicCubit.shufflePlay(), icon: Icon(Icons.shuffle)),
                  VolumeButtonWidget(),
              ...
              body: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: isDark
                        ? [
                      AppColors.dark.gradientStart,
                      AppColors.dark.gradientEnd,
                    ]
                        : [
                      AppColors.light.gradientStart,
                      AppColors.light.gradientEnd,
                    ],
